...
class ListStudenSurvey extends Component {
    constructor(props) {
        super(props);
    }
    _renderItemChild = ({ item, index }) => {
        return (
            <TouchableOpacity
                onPress={() => Utils.goscreen(this, 'sc_KhaosatHome', { student: item, flagNotify: false, IDChiNhanh: item.IDChiNhanh })}
...
export default Utils.connectRedux(ListStudenSurvey, mapStateToProps, true);