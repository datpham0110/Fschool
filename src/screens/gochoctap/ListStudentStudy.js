...
class ListStudentStudy extends Component {
    constructor(props) {
        super(props);
    }
    _renderItemChild = ({ item, index }) => {
        return (
            <TouchableOpacity
                onPress={() => Utils.goscreen(this, 'sc_StudySpace', { student: item, flagNotifiy: false, IDChiNhanh: item.IDChiNhanh })}
...
export default Utils.connectRedux(ListStudentStudy, mapStateToProps, true);