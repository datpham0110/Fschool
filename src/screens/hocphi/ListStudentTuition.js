...
class ListStudentTuition extends Component {
    ...
    _renderItemChild = ({ item, index }) => {
        return (
            <TouchableOpacity
                onPress={() => Utils.goscreen(this, 'sc_HocPhi', { hocsinh: item, isNotify: false })}
...
export default Utils.connectRedux(ListStudentTuition, mapStateToProps, true);