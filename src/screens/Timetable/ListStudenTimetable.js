...
class ListStudenTimetable extends Component {
    constructor(props) {
        super(props);
    }
    _renderItemChild = ({ item, index }) => {
        return (
            <TouchableOpacity
                onPress={() => Utils.goscreen(this, 'sc_ThoiKhoaBieu', { student: item, flagNotify: false, IDChiNhanh: item.IDChiNhanh })}
...
export default Utils.connectRedux(ListStudenTimetable, mapStateToProps, true);