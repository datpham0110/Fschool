...
import {
    Image, View, StyleSheet, Text, Platform, TouchableOpacity, CameraRoll, PermissionsAndroid,
    FlatList, Linking
} from 'react-native';
...
export default class MediaPicker extends Component {
    constructor(props) {
        ...
        options = this.props.navigation.state.params; //--options media
    ...
    onPlayVideo = (suri) => {
        Utils.goscreen(this, 'ManHinh_PlayMedia', { source: { uri: suri } });
    }
    ...
    _openCamrera = () => {
        Utils.goscreen(this, 'Modal_TakeCamera', { onResponse: this.onResponse, options });
