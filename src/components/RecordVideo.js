...
export default class RecordVideo extends Component {
  ...
  postFeeds = (optionsCus) => {
    ...
    options = {
      type: 'Videos', //All,Videos,Photos - default
        ...
        >
          ...
          <View style={[nstyles.nrow, {
            ...
            <TouchableOpacity onPress={() => this.recordVideo()}>
              <Image style={nstyles.nAva80} source={this.state.isRecording ? Images.icVideoRecording : Images.icRecordVideo} />
            </TouchableOpacity>
            <TouchableOpacity disabled={this.state.isRecording} onPress={() => this.changeType()}
              style={{ opacity: this.state.isRecording ? 0 : 1 }}>
